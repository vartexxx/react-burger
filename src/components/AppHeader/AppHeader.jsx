            ...
            <div className={styles.header__container}>
                <nav className={`${styles.header__menu} pt-4 pb-4`}>
                    <ul className={styles.header__list}>
                        <li>
                            <Link to={'/'} className={`${styles.header__link} pt-4 pr-5 pb-4 pl-5`}>
                                <BurgerIcon type="primary" />
                                <span className="text text_type_main-default ml-2">Конструктор</span>
                            </Link>
                        </li>
                        <li>
                            <Link to={'/feed'} className={`${styles.header__link} pt-4 pr-5 pb-4 pl-5 ml-2`}>
                        ...
                        <li>
                            <Link to={'/profile'} className={`${styles.header__link} pt-4 pr-5 pb-4 pl-5`}>
